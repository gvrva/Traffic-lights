...
В связи с неудовлетворительными результатами было принято решение использовать модель, которая предсказывала бы не только bounding box'ы, но и сигнал светофора.
